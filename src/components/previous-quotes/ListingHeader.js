...
function ListingHeader() {
  const { filterQuery, paginationMeta } = useContext(QuotesContext);
        ...
        <div className="pr-4 mb-2 md:mb-0">
          ...
          <div className="inline-block relative w-24 ml-4">
            <select
              ...
              value={perPageValue}
              onChange={(event) => {
                apiClient.setFilterParam("per_page", event.target.value);
        ...
        <div>
          ...
          <div className="inline-block relative w-48 ml-4">
            <select
              ...
              value={orderValue}
              onChange={(event) => {
                apiClient.setFilterParam("order", event.target.value);
